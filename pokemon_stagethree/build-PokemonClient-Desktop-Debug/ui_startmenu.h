...
public:
    ...
    {
        StartMenu->setWindowTitle(QApplication::translate("StartMenu", "Form", nullptr));
        loginName->setPlaceholderText(QApplication::translate("StartMenu", "Your Account", nullptr));
        loginPassword->setInputMask(QString());
        loginPassword->setText(QString());
        loginPassword->setPlaceholderText(QApplication::translate("StartMenu", "Your Password", nullptr));
        loginButton->setText(QApplication::translate("StartMenu", "Login ", nullptr));
        signupButton->setText(QApplication::translate("StartMenu", "Sign up", nullptr));
