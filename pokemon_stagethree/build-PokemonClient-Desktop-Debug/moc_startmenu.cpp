...
#include "../PokemonClient/startmenu.h"
...
QT_MOC_LITERAL(3, 22, 16), // "setOnlineUsrList"
QT_MOC_LITERAL(4, 39, 6), // "setUsr"
QT_MOC_LITERAL(5, 46, 8), // "dataRecv"
QT_MOC_LITERAL(6, 55, 22), // "on_loginButton_clicked"
QT_MOC_LITERAL(7, 78, 23) // "on_signupButton_clicked"

    },
    "StartMenu\0switchPage\0\0setOnlineUsrList\0"
    "setUsr\0dataRecv\0on_loginButton_clicked\0"
...
void StartMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->setOnlineUsrList((*reinterpret_cast< QJsonDocument(*)>(_a[1]))); break;
        case 2: _t->setUsr((*reinterpret_cast< QJsonDocument(*)>(_a[1]))); break;
        ...
        {
            using _t = void (StartMenu::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&StartMenu::switchPage)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (StartMenu::*)(QJsonDocument );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&StartMenu::setOnlineUsrList)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (StartMenu::*)(QJsonDocument );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&StartMenu::setUsr)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void StartMenu::switchPage(int _t1)
{
...
// SIGNAL 1
void StartMenu::setOnlineUsrList(QJsonDocument _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void StartMenu::setUsr(QJsonDocument _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
