...
public:
    ...
    {
        PlayerInfo->setWindowTitle(QApplication::translate("PlayerInfo", "Form", Q_NULLPTR));
        uiddisplay->setText(QApplication::translate("PlayerInfo", "TextLabel", Q_NULLPTR));
        nicknamedisplay->setText(QApplication::translate("PlayerInfo", "TextLabel", Q_NULLPTR));
        label->setText(QApplication::translate("PlayerInfo", "Uid: ", Q_NULLPTR));
        label_2->setText(QApplication::translate("PlayerInfo", "Nickname: ", Q_NULLPTR));
    } // retranslateUi
