...
public:
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        loginName->setPlaceholderText(QApplication::translate("MainWindow", "Your Account", Q_NULLPTR));
        loginPassword->setInputMask(QString());
        loginPassword->setText(QString());
        loginPassword->setPlaceholderText(QApplication::translate("MainWindow", "Your Password", Q_NULLPTR));
        logininButton->setText(QApplication::translate("MainWindow", "Login in", Q_NULLPTR));
