...
QT_MOC_LITERAL(1, 9, 12), // "setClientUsr"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 15), // "setOtherUsrInfo"
QT_MOC_LITERAL(4, 39, 8), // "dataRecv"
QT_MOC_LITERAL(5, 48, 20), // "showPlayerInfoDetail"
QT_MOC_LITERAL(6, 69, 16) // "QListWidgetItem*"

    },
    "Mainpage\0setClientUsr\0\0setOtherUsrInfo\0"
    "dataRecv\0showPlayerInfoDetail\0"
    "QListWidgetItem*"
};
...
void Mainpage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setClientUsr((*reinterpret_cast< QJsonDocument(*)>(_a[1]))); break;
        case 1: _t->setOtherUsrInfo((*reinterpret_cast< QJsonDocument(*)>(_a[1]))); break;
        case 2: _t->dataRecv(); break;
        case 3: _t->showPlayerInfoDetail((*reinterpret_cast< QListWidgetItem*(*)>(_a[1]))); break;
        default: ;
        }
    }
}
